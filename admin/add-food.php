    ...
    <div class="main-content">
        <div class="wrapper">
            ...
            if(isset($_POST['submit'])){
                ...
                //check whether the select image is clicked or not and upload the image only if the image selected
                if(isset($_FILES['image']['name'])){
                    ...
                    //check whether the image is selected or not and upload image only if selected
                     if($image_name !=""){
                        //image is selected
                        // rename the image
                        //get the extension of selected image(jpg,png) "a.jpg"-> a jpg
                        $ext = end( explode('.',$image_name));

                        // create new name for image
                        $image_name = "Food-Name-".rand(000,999).".".$ext; //eg Food-Name-657.jpg 
