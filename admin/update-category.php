<?php include('partials/menu.php');?>
    <div class="main-content">
        ...
        <?php
            //check whether the id is or not
            if(isset($_GET['id'])){
        ...
        <?php
            if(isset($_POST['submit'])){
                ...
                //check wether the image is selected 
                ...
                // redirect to Menage category dwith message
                ...
                if($res2==true){
                    ...
                    //failed to upload
                    $_SESSION['update'] = "<div class='error'> Fail to updated Category...</div>";
                    header('location:'.SITEURL.'admin/manage-category.php');
                }
